        ...
        <div className="flex items-center justify-between h-16 bg-black">
          <div className="flex items-center px-4">
            <button
              ...
              className="text-white focus:outline-none focus:text-gray-700"
            >
              <svg
          ...
          {userName && (
            <div className="px-4 relative">
              <button
                ...
                className="flex items-center gap-2 bg-[#313438] text-white px-4 py-2 rounded-lg text-sm transition duration-300  sm:flex"
              >
                <UserIcon />
                Bem-vindo, {userName}
              </button>
              ...
              {showDropdown && (
                <div className="absolute right-4  bg-[#313438] text-white rounded-lg shadow-lg py-2 w-40 z-50">
                  <button
          ...
          <div className="grid grid-cols- sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-zinc-800 rounded-xl p-5 shadow-md flex flex-col justify-between">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="text-center h-14 text-white"
              >
                <path
                  fillRule="evenodd"

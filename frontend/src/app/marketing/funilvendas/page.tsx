...
const FunilVendas = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white px-6 py-10">
      <h1 className="text-3xl font-bold mb-6">Gerar Funil De Vendas</h1>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <textarea
            ...
            placeholder="Ex: Cria um funil de vendas para um nicho de emagrecimento"
          />
          <button
            onClick={handleGerar}
        ...
        <div className="relative">
          <label className="text-sm text-zinc-400">Funil de Vendas Gerado:</label>
          <pre className="bg-zinc-800 text-green-400 p-4 rounded-xl overflow-auto text-sm leading-relaxed min-h-[250px] border border-zinc-700">
            {code || "// O funil de vendas gerado será exibido aqui..."}
          </pre>
        </div>
      </div>
    </div>
